export const SLOT_STATUSES = {
  ...
  pencilled:            { label: 'Pencilled',     color: 'bg-amber-100 text-amber-800 border-amber-200',    dot: 'bg-amber-400'          },
...
// Statuses editable by mediator/clerk
export const EDITABLE_STATUSES = ['available', 'unavailable', 'ask_me']

// Statuses CRA can set (on not_set / available / unavailable slots)
export const CRA_EDITABLE_STATUSES = ['available', 'unavailable', 'pencilled']
