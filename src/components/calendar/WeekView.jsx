...
function MergedSlotCell({ slotData, onClick, selected, selectMode }) {
...
export default function WeekView({ currentDate, slots, series, mediatorId, selectMode, selectedSlots, onToggleSlot }) {
  ...
  function handleCellClick(day, period) {
    ...
    if (selectMode) {
      // CRA: only selectable if not_set or available
